    ...
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wide">Lacoste</div>
          </Link>
          <p>
            3252 Winding Way, Central Plaza, Willowbrook, CA 90210, United
            States
          </p>
          <span className="font-semibold">hello@Lacoste.dev</span>
          <span className="font-semibold">+1 234 567 890</span>
          <div className="flex gap-6">
            <Image src="/icons/facebook.png" alt="" width={16} height={16} />
            <Image src="/icons/instagram.png" alt="" width={16} height={16} />
            <Image src="/icons/youtube.png" alt="" width={16} height={16} />
            <Image src="/icons/pinterest.png" alt="" width={16} height={16} />
            <Image src="/icons/x.png" alt="" width={16} height={16} />
          </div>
        </div>
        {/* CENTER */}
